(function () {
  ...
  //Read the data
  csv("topsongs.csv").then( function(data) {
    ...
    const x = linear()
      .domain([min(data, function(d) { return d.year; }), max(data, function(d) { return d.year; })])
      .range([ 0, width ]);
    svg.append("g")
    ...
    // Add Y axis
    const y = linear()
      .domain( [0, max(data, function(d) { return Number(d.count); })])
      .range([ height, 0 ]);
    svg.append("g")
      .call(axisLeft(y));
