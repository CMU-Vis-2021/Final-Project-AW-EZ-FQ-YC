(function () {
  ...
  var svg = d3.exports.select("body")
    .append("svg")
  ...
  var formatTime = d3.exports.timeFormat("%Y");

  // Transpose the data into layers
  var dataset = d3.exports.stack()(["male", "female", "mixed"].map(function(fruit) {
    return data.map(function(d) {
      return {x: formatTime(d.year), y: +d[fruit]};
    });
  }));

  console.log(d3.exports.stack().keys(["male", "female", "mixed"])(data));

  // Set x, y and colors
  var x = d3.exports.scaleOrdinal()
    .domain(dataset[0].map(function(d) { return d.x; }))
    .rangeRoundBands([10, width-10], 0.02);

  var y = d3.exports.scaleLinear()
    .domain([0, d3.exports.max(dataset, function(d) {  return d3.exports.max(d, function(d) { return d.y0 + d.y; });  })])
    .range([height, 0]);
  ...
  var xAxis = d3.exports.svg.axis()
    .scale(x)
    .orient("bottom")
    .tickFormat(d3.exports.time.format("%Y"));
  ...
  groups.selectAll("rect")
    ...
    .on("mousemove", function(d) {
      var xPosition = d3.exports.mouse(this)[0] - 15;
      var yPosition = d3.exports.mouse(this)[1] - 25;
