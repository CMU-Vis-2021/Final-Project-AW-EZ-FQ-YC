(function () {
  ...
  let chart = BarChart(number, {
    x: d => d.cnt,
    y: d => d.id,
    yDomain: groupSort(number, ([d]) => -d.cnt, d => d.id), // sort by descending frequency
    xFormat: "",
  ...
  function BarChart(data, {
    ...
    const yScale = band(yDomain, yRange).padding(yPadding);
    const xAxis = axisTop(xScale).ticks(width / 800, xFormat);
